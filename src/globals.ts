...
/**
 * Maximal length of a media description.
 * @readonly
 */
const MAX_MEDIA_DESCRIPTION_LENGTH: Readonly<number> = 1024

export { MAX_COLOR_NUMBER, MAX_CUSTOM_ID_LENGTH, MAX_BUTTON_LABEL_LENGTH, MAX_SELECT_MENU_PLACEHOLDER_LENGTH, MAX_SELECT_MENU_OPTIONS, MAX_CONTENT_LENGTH, MAX_MEDIA_DESCRIPTION_LENGTH }
