    ...
    return (
        <>
            <article className="bg-transparent flex flex-col">
                <div className="w-full p-6 border-l-[3px] bg-[#101010] border-l-[#FF55FF] flex justify-between items-center cursor-pointer" onClick={handleClick}>
                    ...
                    <IoIosArrowDown
                        size={25}
                        className={`bg-transparent duration-150 ${isToggled ? "-rotate-180" : "rotate-0"}`}
                    />
                </div>
